...
- Totalmente compatible con los bloques Carrito y Bloque de Finalizar compra del editor de bloques de WordPress.
...
**WC - APG Free Shipping** ha sido programado a partir del plugin [*WC - APG Weight Shipping*](https://wordpress.org/plugins/woocommerce-apg-weight-and-postcodestatecountry-shipping/) de [Art Project Group](https://profiles.wordpress.org/artprojectgroup/) y la clase original *WC_Shipping_Free_Shipping* de [*WooCommerce - excelling eCommerce*](https://wordpress.org/plugins/woocommerce/), lo que le añade algunas de las funcionalidades presentes en el primero a la sencillez del segundo.

### Más información

En nuestro sitio web oficial puedes obtener más información sobre [**WC - APG Free Shipping**](https://artprojectgroup.es/plugins-para-woocommerce/wc-apg-free-shipping).
...
- Buscar **WC - APG Free Shipping** en el buscador disponible en _Plugins -> Añadir nuevo_ y pulsar el botón _Instalar ahora_.

2. Activar el plugin a través del menú _Plugins_ en el Panel de Administración de WordPress.
3. Configurar el plugin en _WooCommerce -> Ajustes -> Envío_ o a través del botón _Ajustes_.
...
- Corregida la lista de métodos de envío que no se actualizaba al añadir, eliminar o activar/desactivar métodos en una zona (podía aparecer vacía o desactualizada en tiendas con object cache persistente).
- Mejorada la invalidación de caché de categorías, etiquetas y valores de atributo de producto, para que los nuevos aparezcan de inmediato.
- Compatible con WooCommerce 10.9 y WordPress 7.1.
...
- Añadido el filtro `apg_free_shipping_final_label`.
...
- Añade soporte al Bloque de Finalizar compra.
- Mejora de la seguridad.
- Mejora de rendimiento general.
- Adecuación completa del código a los estándares de seguridad de WordPress.
- Pequeños arreglos.
...
- Añade soporte a los bloques Carrito y Bloque de Finalizar compra.
...
- Nueva interfaz y función de gestión para añadir gastos de envío gratuitos adicionales.
...
- Traducción al portugués por [**Álvaro Góis dos Santos**](http://www.efeitoavestruz.pt).
...
- Arreglo de error que hacía que el envío gratuito fuera siempre el predeterminado al alcanzar el importe configurado.
...
- Nueva hoja de estilo adaptable.
...
- Eliminación de errores internos que aparecían al instalar el plugin sin configuración inicial.
...
- Añadida nueva opción que oculta el resto de gastos de envío al estar disponible.
- Arreglo de error que hacía que no funcionara si no se había configurado ningún grupo.
...
- Actualización de las hojas de estilo acorde al nuevo estilo de WordPress.
...
- _Português_: por [**Álvaro Góis dos Santos**](http://www.efeitoavestruz.pt).
